...
/**
 * @brief Set the mass of a stellar particle.
 *
 * @param p The particle to act upon
 * @param mass The new mass.
 */
inline static void stars_set_mass(
    struct spart* restrict p, const float mass) {
  if (mass < 0)
    error("Particles cannot have negative mass: %g", mass);
...
/**
 * @brief Initializes constants related to stellar evolution.
 *
