...
/**
 * @brief Initialize the physical properties of the stars scheme.
 *
 ...
 */
INLINE static void stars_props_init_physics(
    struct stars_props *sp, const struct phys_const *phys_const,
...
INLINE static void stars_props_init(struct stars_props *sp,
  ...
  stars_props_init_physics(sp, phys_const, us, params, cosmo);
}
